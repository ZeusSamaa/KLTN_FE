...
export default function BusinessContact() {
    ...
    function getAllMessagesWithUserByChannelID() {
        ...
        MessageService
            .getConversationDetailInBusiness(selectedChannelID)
            .then((res) => {
    ...
    const personalInfo = () => {
        ...
        return {
            full_name: userInChannel?.student.user_person.full_name || "",
            avatar_path: userInChannel?.student.user_person.image || "https://cdn-icons-png.flaticon.com/512/3607/3607444.png"
        }
    }
                                    ...
                                    <React.Fragment>
                                        {
                                            usersInMessage.length > 0 ? usersInMessage.map((user, index) => (
                                                ...
                                                >
                                                    <img 
                                                        src={user.student.user_person.image || 'https://cdn-icons-png.flaticon.com/512/3607/3607444.png'} 
                                                        alt="" 
                                                        className={cx("user-avatar")}
                                                    />
                                                    <div className={cx("general-info")}>
                                                        <h5>{user.student.user_person.full_name}</h5>
